...
export class ProdutosFavoritosComponent implements OnInit {
  ...
  findByIdCategoria() {
    this.categoriaService.temaPeloId(this.idCategoria).subscribe((resposta: Categoria) => {
  ...
  publicar () {
    ...
    this.produtoService.cadastrarProduto(this.produto).subscribe((resposta: Produto) => {
